 ...
 * - poucasUnidades: true = Mostra aviso de "Poucas Unidades", false = Normal
 */

const listaProdutos = [
    // --- BATERIAS ---
    { id: "1", titulo: "Big Panda", desc: "36Tiros Calibre 20", preco: "30", imagem: "1.png", premium: true, stock: true, poucasUnidades: false },
    { id: "2", titulo: "Feliz Ano Novo", desc: "36Tiros Calibre18", preco: "25", imagem: "2.png", premium: false, stock: true, poucasUnidades: false },
    { id: "3", titulo: "Mega Panda", desc: "100 Tiros Calibre 16", preco: "50", imagem: "10.png", premium: true, stock: false, poucasUnidades: false },
    { id: "4", titulo: "Festival Balls ou Sea Crab", desc: "48 Tiros Calibre 20", preco: "40", imagem: "3.png", premium: true, stock: true, poucasUnidades: true },
    { id: "5", titulo: "Gunfire", desc: "100Tiros Calbire 20", preco: "75", imagem: "4.png", premium: true, stock: true, poucasUnidades: false },
    { id: "6", titulo: "Happy Alfa", desc: "100 Tiros Calibre 16", preco: "45", imagem: "5.png", premium: false, stock: false, poucasUnidades: false },
    { id: "7", titulo: "Happy Alfa", desc: "49Tiros Calibre16", preco: "30", imagem: "6.png", premium: false, stock: true, poucasUnidades: false },
    { id: "8", titulo: "Happy Panda", desc: "36Tiros Calibre16", preco: "20", imagem: "7.png", premium: false, stock: true, poucasUnidades: true },
...
const listaPetardos = [
    ...
    { id: "3", titulo: "P2", desc: "Caixa P2 10 UNIDADES", preco: "10", imagem: "3.png", premium: false, stock: false, poucasUnidades: false },
    ...
    { id: "6", titulo: "Foguete Viagem Lunar", desc: "144 UNIDADES", preco: "20", imagem: "6.png", premium: false, stock: true, poucasUnidades: false },
    { id: "7", titulo: "Candelas", desc: "Candelas 12 UNIDADES", preco: "15", imagem: "7.png", premium: false, stock: true, poucasUnidades: false },
    ...
    { id: "15", titulo: "6 MIC", desc: "", preco: "10", imagem: "15.png", premium: false, stock: true, poucasUnidades: false },
    { id: "16", titulo: "Foguere Nacional", desc: "12 UNIDADES", preco: "35", imagem: "16.png", premium: false, stock: true, poucasUnidades: false },
];
